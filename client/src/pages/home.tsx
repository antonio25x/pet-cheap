          ...
          <div className="flex flex-col lg:flex-row items-center justify-between">
            <div className="lg:w-1/2 mb-10 lg:mb-0">
              ...
              >
                ...
                From premium food to fun toys, we've got you covered.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Pet care specialists available
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {products.slice(0, 2).map((product) => (
              <Card
                key={product.id}
                className="product-card bg-card border border-border rounded-xl overflow-hidden shadow-md transition-all duration-200 hover:shadow-lg hover:-translate-y-1"
